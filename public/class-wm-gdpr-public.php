<?php
	...
	class Wm_Gdpr_Public
	{
		...
		public function enqueue_scripts () {
			...
			add_filter('wm_plugin_cookie-skip', function ($script_handles)  {
				$script_handles[] = 'wm__iub-autoblock';
				$script_handles[] = 'divi-custom-script';
				$script_handles[] = 'mediaelement';
				$script_handles[] = 'wp-mediaelement';
				$script_handles[] = 'et-core-common	';
				return $script_handles;
			});
			// Enqueue Iubenda scripts
			$cookie_policy_id = $this->get_cookie_policy_id();
			wp_enqueue_script( 'wm__iub-autoblock', '//cs.iubenda.com/autoblocking/' . $cookie_policy_id . '.js', [], $this->version, false );
			wp_enqueue_script( 'wm__iub-stub', '//cdn.iubenda.com/cs/ccpa/stub.js', [], $this->version, false );
			//wp_enqueue_script( 'wm__iub-stub', '//cdn.iubenda.com/cs/gpp/stub.js', [], $this->version, false );
		 ...
		 */
		public function skip_cs_script () {
			$script_handles = apply_filters( 'wm_plugin_cookie-skip', [ "wm__iub-cs" ] );
		...
		private function get_cookie_policy_id() {
